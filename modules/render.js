...
export const render = () => {
  ...
  $("#topbar-actions").innerHTML = state.auth.user && !locked ? `
    <button type="button" class="logout-button" data-action="auth-logout" title="Abmelden" aria-label="Abmelden">
    ...
    <button type="button" class="user-chip" data-nav="profile" title="Mein Zugang öffnen">
