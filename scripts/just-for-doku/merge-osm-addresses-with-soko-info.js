...
// Zweck: Generiert die Datei fuer window.REINICKENDORF_ADDRESS_POINTS mit
// OSM-Adressdaten, angereichert um die SOKO-Zuordnung aus
// public/data/soko-strassenverzeichnis.js.
// Aufbau:
// - fetchOverpass(): laedt die OSM-Daten aus Overpass
// - addressFromElement(): normalisiert und filtert OSM-Elemente
// - assignmentFor(): ermittelt SOKO, Ortsteil und normalisierte Strasse
...
fetchOverpass().then(data => {
  // Rohdaten -> Adressobjekte -> sortiert und dedupliziert
  ...
  // Datei im erwarteten Browser-Format schreiben
  const payload = {
